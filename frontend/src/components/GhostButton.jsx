export default function GhostButton({ children, onClick, disabled, icon, style = {} }) {
  return (
    <button onClick={onClick} disabled={disabled}
      style={{ display: 'flex', alignItems: 'center', gap: '7px', padding: '7px 13px', borderRadius: '4px',
        border: '1px solid rgba(180,178,170,0.16)', background: 'rgba(255,255,255,0.03)', color: '#d9d6cd',
